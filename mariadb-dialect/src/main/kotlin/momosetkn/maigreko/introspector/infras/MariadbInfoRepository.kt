...
internal class MariadbInfoRepository(
    ...
    fun getConstraintDetails(
        ...
        return jdbcExecutor.executeQuery(sql, excludeTable) { resultSet ->
            val results = mutableListOf<MariadbConstraintDetail>()
    ...
    fun getColumnDetails(
        ...
        return jdbcExecutor.executeQuery(sql, excludeTable) { resultSet ->
            val results = mutableListOf<MariadbColumnDetail>()
            while (resultSet.next()) {
    ...
    /**
     * Map a result set to a MariadbConstraintDetail entity
     */
    private fun mapConstraintResultSetToEntity(resultSet: ResultSet): MariadbConstraintDetail {
        return MariadbConstraintDetail(
    ...
    /**
     * Map a result set to a MariadbColumnDetail entity
     */
    private fun mapColumnResultSetToEntity(resultSet: ResultSet): MariadbColumnDetail {
        return MariadbColumnDetail(
            tableName = resultSet.getString("table_name"),
            columnName = resultSet.getString("column_name"),
